...
func (_m *Repository) Get(ctx context.Context, id string) (string, error) {
...
func (_c *Repository_Get_Call) RunAndReturn(run func(context.Context, string) (string, error)) *Repository_Get_Call {
	_c.Call.Return(run)
	return _c
}
